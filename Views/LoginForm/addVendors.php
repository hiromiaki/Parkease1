...
<body>
	...
	<main>
    <div class="container">
        <form action="vendor/add" method="post" id="addStaff">
            <h2>Add Vendors</h2>
            <div class="content">

                <div class="input-box">
                    <label for="name">Name</label>
                    <input type="text" required placeholder="Enter worker's name" name="Name" >
                </div>
                ...
                <div class="input-box">
                    ...
                    <input type="num" placeholder="Enter MonthlyRent" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="MonthlyRent" required>
                </div>

</div>
<div class="regCan">
    <button type="submit" class="btn btn-success btn-sn">Register</button> <br>
