...
<head>
    ...
    <style>
        ...
        .input-box label, textarea, .gender-title{
            width: 95%;
            color: #2f4f4f;
            font-weight: bold;
            margin: 5px 0;
...
<body>
    ...
    <div class="container">
        <form action="<?= base_url('editTicket/'.$ticket['id'])?>" method="post" onsubmit="return checkFormChanges()" id="editTicket">
            ...
            <div class="content">
                ...
                <div class="input-box">
                    ...
                    <input type="text" name="Price" value="<?= $ticket['Price'] ?>" required>
                </div>
                ...
                <div class="input-box">
                    ...
                    <textarea type="text" name="Description" value="<?= $ticket['Description'] ?>" rows="10" cols="30"><?= $ticket['Description'] ?></textarea>
                </div>

                <div class="input-box">
                    <label for="image">Image:</label>
                    <?php if ($ticket['Img']): ?>
                         <img src="<?= base_url('photos/' . $ticket['Img']) ?>" alt="Current Image" style="max-width: 200px;"><br>
                         <input type="hidden" name="existing_image" value="<?= $ticket['Img'] ?>">
                     <?php endif; ?>   
                </div>
...
<div class="regCan">
    ...
    <a href="/tickets" class="btn btn-danger btn-sn">Cancel</a>
</div>
</form>
</div>
</main>	
